...
// 如果该层应被高亮显示，则返回 true。默认情况下仅检查升级。
...
function resetRow(row) {
	if (prompt('您确定要重置此行吗？强烈建议您等到当前运行结束再进行此操作！请输入"我要重置此行"以确认')!="我要重置此行") return
...
VERSION.withoutName = VERSION.num + (VERSION.pre ? " 预发布版 " + VERSION.pre : VERSION.pre ? " Beta " + VERSION.beta : "")
